...
tausta = pygame.image.load("pixil-frame-0.png")
player_avatar = pygame.image.load('bird.png')
PLAYER_X = 150
player_y = 200
player_width = 35
player_height = 35
...
SPACING = 170
tube_x1 = game_width 
tube_x2 = game_width + SPACING 
tube_x3 = game_width + SPACING * 2 
tube_x4 = game_width + SPACING * 3
...
player_avatar = pygame.transform.scale(player_avatar, (player_width, player_height))
...
def draw():
    naytto.blit(player_avatar, (player.x, player.y))
...
while True:
    ...
    #törnien piirtäminen
    tube1 = pygame.draw.rect(naytto, (0,200,0), (tube_x1, 0, TUBE_WIDTH, tube_height1))
    tube2  = pygame.draw.rect(naytto, (0,200,0), (tube_x2, 0, TUBE_WIDTH, tube_height2))
    tube3  = pygame.draw.rect(naytto, (0,200,0), (tube_x3, 0, TUBE_WIDTH, tube_height3))
    tube_4  = pygame.draw.rect(naytto, (0,200,0), (tube_x4, 0, TUBE_WIDTH, tube_height4))

    inv_tube1 = pygame.draw.rect(naytto, (0,200,0),(tube_x1, tube_height1+TUBES_GAP, TUBE_WIDTH, game_height-TUBES_GAP-tube_height1) )
    inv_tube2 = pygame.draw.rect(naytto, (0,200,0),(tube_x2, tube_height2+TUBES_GAP, TUBE_WIDTH, game_height-TUBES_GAP-tube_height2) )
    inv_tube3 = pygame.draw.rect(naytto, (0,200,0),(tube_x3, tube_height3+TUBES_GAP, TUBE_WIDTH, game_height-TUBES_GAP-tube_height3) )
    inv_tube4 = pygame.draw.rect(naytto, (0,200,0),(tube_x4, tube_height4+TUBES_GAP, TUBE_WIDTH, game_height-TUBES_GAP-tube_height4) )
...
#gravitaatio
    ...
    #pelin vaikeuttaminen
    if not game_over and score //5:
        TUBE_VELOCITY = min(15, 3 + score * 0.05)
        TUBES_GAP = max(80, 150 - score * 0.75)
